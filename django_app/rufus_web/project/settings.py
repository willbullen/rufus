...
This settings file is configured to work with environment variables
...
ROSBRIDGE_HOST = env('ROSBRIDGE_HOST', default='localhost')
ROSBRIDGE_PORT = env.int('ROSBRIDGE_PORT', default=9090)
